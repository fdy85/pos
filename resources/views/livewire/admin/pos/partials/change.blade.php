    ...
    <div class="w-full my-2 bg-white rounded-md shadow-md">
        <div class="flex-col p-2">
            <div class="flex justify-between">
                <x-jet-input wire:model="cash" type="number" step=".01" class="form-input font-bold text-lg" onclick="this.select()"/>
            ...
            <div class="flex justify-between">
                <x-jet-label class="p-2 text-slate-500 text-lg" value="Cambio:" />
                <x-jet-label class="p-2 text-sky-800 text-xl" value="${{ $change }}" />
            </div>
