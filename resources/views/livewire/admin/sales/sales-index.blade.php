...
<div class="w-full">
    <x-common.main-content sucursal='{{ auth()->user()->branchOffice->name }}' >
        <x-slot name="content">
            ...
            @livewire('admin.sales.seek-sales-by-cashier')
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                {{-- Actions --}}
                                    <a onclick="printTicket({{ $item['id'] }})" class="cursor-pointer" title="Imprimir Folio {{ $item['id'] }}">
                                        <i class="fas fa-receipt text-sky-900 text-xl"></i>
                                    </a>
    ...
    {{-- Modal --}}
    @include('livewire.admin.sales.partials.form')

    <script>
        function printTicket(id) {
            //console.log(id);
            myReceiptWindow = window.open("sale/print-ticket?selectedId="+id,"myWin", "left=150, top=130, width=400, height=600");
